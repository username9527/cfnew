...
// --- 硬编码配置 ---
const authToken = 'a89316bd-1539-45dc-bee4-266fc60a0f2b';
let fallbackAddress = '';
const socks5Config = '';
...
const enableGitHubPreferred = false;
...
const directDomains = [
  { name: "香港", domain: "hk.cle.us.ci" }, 
  { name: "日本", domain: "jp.cle.us.ci" }, 
  { name: "韩国", domain: "kr.cle.us.ci" }, 
  { name: "新加坡", domain: "sg.cle.us.ci" }, 
  { name: "美国", domain: "us.cle.us.ci" }, 
  { name: "香港", domain: "hk443.018881.xyz" }, 
  { name: "日本", domain: "jp443.018881.xyz" }, 
  { name: "韩国", domain: "kr443.018881.xyz" }, 
  { name: "新加坡", domain: "sg443.018881.xyz" }, 
  { name: "美国", domain: "us443.018881.xyz" }
];
